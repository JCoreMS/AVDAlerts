...
|---                                                                |---                      |---           |---           |  
| :one: AVD-HostPool-Capacity                                           | 95% / 85%          | Log Analytics  |  5 min       |
...
| :two: AVD-Storage-Low Space on ANF Share-XX Percent Remaining-{volumename} | 5 / 15               | Metric Alerts |   1 hour      |
| :two: AVD-Storage-Low Space on Azure File Share-XX% Remaining      | 5 / 15                | Log Analytics  |   1 hour     |
